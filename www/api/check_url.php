...
$mnm_over = $globals['base_static']."img/api/mnm-over-01.png";
$mnm_vote = $globals['base_static']."img/api/mnm-vote-01.png";
$mnm_add = $globals['base_static']."img/api/mnm-add-01.png";
