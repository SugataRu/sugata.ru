...
$globals['site_name'] = 'Sugata';
$globals['site_shortname'] = 'sugata'; //Пространство по умолчанию для главной
...
$globals['lang'] = $dblang  = 'ru';

//$globals['help_url'] = 'help';
...
$globals['db_name'] = 'sugata';
$globals['db_user'] = 'admin';
$globals['db_password'] = 'qwer14';
...
// Administrator email
$globals['adm_email'] = 'budo@narod.ru';
$globals['adm_list_email'] = 'budo@narod.ru';
$globals['adm_list_email_from'] = 'budo@narod.ru';
...
//$globals['static_server'] = 'http://static.sugata.ru';
...
$globals['base_url'] = '/';
$globals['top_logo'] = 'img/eli.png';
$globals['thumbnail_logo'] = 'img/eli_thumbnail.png';
$globals['legal'] = '/help';
...
$globals['comment_highlight_karma'] = 65;
...
$globals['karma_propaganda'] = 12; // min user karma to avoid extra spam/propaganda checks in the submits (мин карма, чтобы избежать доп/ проверок спама / пропаганды//)
...
$globals['instant_karma_per_depublished'] = 1; //karma substracted when depublished (карма отнимается, когда depublished)
$globals['instant_karma_per_discard'] = 0.2; //karma substracted when discarded (карма вычитается при отбрасывании)
...
$globals['time_enabled_comments'] = 1814400; // было 604800 7 days стало 1814400 3 недели
...
$globals['time_enabled_votes'] = 604800; // было 345600 4 days стало 7 дней
...
$globals['new_user_links_limit'] = 1; //links allowed to submit in interval for new users (ссылки разрешено отправлять в интервале для новых пользователей)
...
$globals['post_highlight_karma'] = 45;
$globals['post_hide_karma'] = -50;

$globals['draft_time'] = 1200; // Time unsent drafts will be kept (20 minutes) // Время неотправленных черновиков будет сохранено (20 минут)
$globals['draft_limit'] = 5; // Max unset drafts at the same time //Максимум сбросить проектов одновременно
...
*/
// If you did it, change this to true false
...
// Haanga templates configuration //php_admin_value open_basedir "/var/www/stranik/data:."
...
// Put your keys en to enable recaptcha. ВВЕДИТЕ ваш код
...
$globals['Amazon_S3_upload'] = false;
...
$globals['use_fontawesome_cdn'] = false; // If false serve fontawesome locally
//$globals['css_color'] = 'css/es/mnmcol17.css';
$globals['html_main'] = 'html1.php';

// Store access stats (Хранить статистику доступа)
$globals['save_pageloads'] = false;

$globals['enabled_tags'] = 'b|i|em|strong|del|sup|sub|quote'; // HTML tags allowed for comments and posts
...
$globals['article_promoted_min_votes'] = 4;
$globals['article_promoted_min_karma'] = 5;
$globals['article_promoted_max_time_from_publish'] = 1000; // Article max time from published in hours

$globals['preguntame_home_sidebar'] = true;

// Максимальное количество анонимных голосов против голосов пользователей за 1/2 часа 
// 3 означает 3 раза анонимные голоса в качестве голосов пользователей за этот период
$globals['anon_to_user_votes'] = 0.7;
