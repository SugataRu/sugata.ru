...
$range_names  = array(_('24 часа'), _('48 часов'), _('неделя'));
$range_values = array(1, 2, 7);

$from = check_integer('range');

$globals['description'] = 'Облако тегов на Sugata. Это теги (темы), которые интересны нашим читателям. Читаем, комментируем их.';
...
do_header(_('Облако тегов') . ' | '._('sugata'));
do_tabs('main', _('тем, меток'), true);
print_period_tabs();
...
echo '<div class="topheading"><h1>+ '.$words_limit.'</h1></div>';
