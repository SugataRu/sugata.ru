...
$range_names  = array(_('24 часа'), _('48 часов'), _('неделя'), _('месяц'), _('год'), _('все время'));
...
do_header(_('облако сайтов') . ' | ' . _('sugata'));
do_tabs("main", _('+ сайты'), true);
print_period_tabs();
...
echo '<div class="topheading"><h1>Наиболее связанные сайты</h1></div>';
...
if ($res) {
    ...
    foreach ($blogs as $url => $count) {
        ...
        echo '<span style="font-size: '.$size.'pt"><a rel="nofollow" href="'.$url.'">'.$text.'</a></span>&nbsp;&nbsp; ';
    }
}
