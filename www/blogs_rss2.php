...
if ($entries) {
    foreach ($entries as $entry) {
        echo "	<item>\n";
        echo "		<sugata:user>$entry->user_login</sugata:user>\n";
        echo "		<sugata:url>".'http://'.get_server_name().$globals['base_url'].'rsss.php'."</sugata:url>\n";
...
function do_header($title)
{
    ...
    echo '     xmlns:sugata="http://sugata.ru/faq-es.php"'."\n";
    echo ' >'. "\n";
    echo '<channel>'."\n";
    ...
    echo"	<image><title>".$title."</title><link>http://".get_server_name().$globals['base_url']."rsss.php</link><url>http://".get_static_server_name().$globals['base_url']."img/eli-rss.png</url></image>\n";
    echo'	<description>'._('Пользовательские блоги').'</description>'."\n";
