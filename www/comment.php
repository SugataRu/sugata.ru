...
if ($link->is_sub) {
    $canonical_base .= 's/'.$link->sub_name.'/';
}

$canonical_base .= 'c/'; ///// dd https://sugata.ru/'.$link->sub_name.'/c/-'.$comment->id.'
$globals['extra_head'] = '<link rel="canonical" href="'.$globals['scheme'].'//sugata.ru/'.$canonical_base.$comment->id.'"/>';
