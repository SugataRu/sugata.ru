...
if (($globals['cli'] === false) && getenv('HTTP_HOST')) {
    ...
    $globals['server_name'] = 'sugata.ru'; // Warn: did you put the right server name?
}
...
// Votes' tags
$globals['negative_votes_values'] = array(-1 => _('не в тему'), -2 => _('старый'), -3 => _('закон'), -4 => _('порно'), -5 => _('спам'), -6 => _('повтор'), -7 => _('другое'), -8 => _('ошибка'), -9 => _('копия/плагиат'));
