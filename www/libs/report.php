...
class Report extends LCPBase
{
    ...
    public static $statuses = [
        ...
        'debate' => 'В дискуссии',
        'penalized' => 'нарушает',
        'dismissed' => 'отбрасываются',
    ];

    public static $reasons = [
        'inappropriate_content' => 'Неподходящий контент',
        'private_data' => 'Содержит ваши личные данные или данные третьих лиц',
        'incites_hatred' => 'Разжигание ненависти',
        'legality' => 'Несоблюдение действующего законодательства РФ',
        'insult' => 'Прямые оскорбления',
        'violence_porn' => 'Порнография или сцены насилия',
        'advertising' => 'Коммерческое продвижение товаров или услуг',
        'spam' => 'Спам',
        'violate_rules' => 'Нарушение правил использования',
    ];
