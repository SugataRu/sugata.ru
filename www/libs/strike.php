...
class Strike
{
    public static $reasons = [
        ...
        'private_data' => 'Содержит личные данные третьей стороны',
        'incites_hatred' => 'Разжигание ненависти',
        'legality' => 'Нарушение законов РФ ',
        'insult' => 'Прямые оскорбления',
        'violence_porn' => 'Порнографические или графические материалы о насилии',
        'advertising' => 'Коммерческое продвижение товаров или услуг',
        'spam' => 'Спам',
        'violate_rules' => 'Нарушает правила использования',
    ];
